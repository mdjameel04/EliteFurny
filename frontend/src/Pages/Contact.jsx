      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
        ...
        <div>
          ...
          <div className="relative mb-8">
            ...
            {/* Social Icons */}
            <div className="absolute bottom-[-20px] left-1/2 transform -translate-x-1/2 bg-white shadow-md rounded-full px-6 py-3 flex items-center gap-5">
          ...
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="p-6 border border-gray-200 rounded-xl shadow-sm bg-white flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Mon–Fri from 9am to 7pm</p>
